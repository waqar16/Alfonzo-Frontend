...
import { FaRegComments, FaFileAlt, FaCogs, FaGraduationCap } from 'react-icons/fa';
import AOS from 'aos';
...
const services = [
  {
    title: 'Consultation',
    description: 'Get expert advice tailored to your needs with our professional consultation services.',
    icon: <FaRegComments className="w-12 h-12 text-white" />,
    aos: 'fade-up', // AOS animation
  },
  {
    title: 'Document Review',
    description: 'Our team will review your documents to ensure accuracy and compliance with legal standards.',
    icon: <FaFileAlt className="w-12 h-12 text-white" />,
    aos: 'fade-up', // AOS animation
  },
  {
    title: 'Custom Solutions',
    description: 'We provide custom solutions to address specific requirements and challenges you face.',
    icon: <FaCogs className="w-12 h-12 text-white" />,
    aos: 'fade-up', // AOS animation
  },
  {
    title: 'Training & Workshops',
    description: 'Participate in training sessions and workshops to enhance your skills and knowledge.',
      ...
      <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="mt-4 text-base leading-7 text-gray-600">
            Explore the range of services we offer to support your legal and business needs.
          </p>
        </div>
