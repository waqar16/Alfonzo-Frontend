...
const SelectLawyer = () => {
  ...
  return (
    <div className="flex flex-col items-center my-24 mt-32 px-4 md:px-16">
      <h1 className="text-[16px]">LAWYERS</h1>
      <h1 className="text-3xl md:text-2xl font-bold text-black text-center md:text-start">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 mt-8 w-10/12">
        {filteredLawyers.map((lawyer) => (
          <div
            ...
            className="bg-white shadow-lg rounded-lg overflow-hidden transform transition-transform duration-200 hover:scale-105 cursor-pointer relative"
          >
            <img
              src={lawyer.image}
              alt={lawyer.name}
            ...
            {selectedLawyer && selectedLawyer.id === lawyer.id && (
              <div className="absolute top-0 left-0 w-full h-full bg-black bg-opacity-75 flex items-center justify-center text-white transition-opacity duration-300">
                <div className="p-4 text-center">
                  ...
                  <button
                    className="bg-white text-black p-2 px-4 rounded-md mt-4 border hover:border-white hover:text-white hover:bg-black transition-colors duration-300"
                    onClick={() => {
